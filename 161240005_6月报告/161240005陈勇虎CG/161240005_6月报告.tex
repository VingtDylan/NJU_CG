...
\section{系统介绍}
    ...
    系统支持两种操作，命令输入方式或者鼠标操作；
        \subsubsection{命令输入方式}
            \textbf{1.读取文件方式}
                ...
                读取$*.txt$文件，文件夹位于$NJU\_CG/scripts$文件夹下，在主界面命令行中输入input name(文件名，不包含后缀)即可.(如果是运行了*.exe 文件，则$*.txt$在此文件夹下的scripts中).
        ...
        \subsubsection{鼠标操作方式}
            ...
            \begin{enumerate}[\indent (1)]
                ...
                \item 修改画笔颜色\\
                      点击画布界面中的图标
                      \includegraphics[scale=0.5]{images/color_icon.png},随后在出现windows系统类似的RGB调色对话框，进行相关的操作即可.
                \item 直线绘制(Bresenham算法)\\
                       点击画布界面中的图标
                      \includegraphics[scale=0.5]{images/line_icon.png},随后在界面中左击两个位置，即可产生一个以此两个位置为端点的直线;
                \item 直线绘制(DDA算法)\\
                      点击画布界面中的图标
                      \includegraphics[scale=0.5]{images/line_icon_DDA.png},随后在界面中左击两个位置，即可产生一个以此两个位置为端点的直线;
                \item 多边形绘制(Bresenham算法)\\
                      点击画布界面中的图标
                      \includegraphics[scale=0.5]{images/polygon_icon.png}, 随后在界面依次左击多边形的各个顶点的位置，最后再点击一次右键，即可产生所要的多边形；
                \item 多边形绘制(DDA算法)\\
                      点击画布界面中的图标
                      \includegraphics[scale=0.5]{images/polygon_fill_icon.png}, 随后在界面依次左击多边形的各个顶点的位置，最后再点击一次右键，即可产生所要的多边形；
                \item 绘制椭圆\\
                      点击画布界面中的图标
                      \includegraphics[scale=0.5]{images/ellipse_icon.png}, 随后在弹出的对话框输入相应id,x,y,rx,ry数据后，点击确认即可.
                \item 绘制曲线(Bezier曲线)\\
                      点击画布界面中的图标
                      \includegraphics[scale=0.5]{images/curve_icon.png}, 随后在界面依次左击各个点击控制点的位置，最后再点击一次右键,即可生成Bezier曲线，为方便观察，控制点之间的线段也会绘制出来.
                \item 绘制曲线(B-spline曲线)\\
                      点击画布界面中的图标
                      \includegraphics[scale=0.5]{images/curve_icon_Bspline.png}, 随后在界面依次左击各个点击控制点的位置，最后再点击一次右键,即可生成B-spline曲线，为方便观察，控制点之间的线段也会绘制出来.
                \item 图元平移\\
                      点击画布界面中的图标
                      \includegraphics[scale=0.5]{images/translate_icon.png}, 随机左键摁住需要平移的图元，鼠标移动，移动完成后，松开左键即可.
                \item 图元旋转\\
                      点击画布界面中的图标
                      \includegraphics[scale=0.5]{images/rotate_icon.png}, 在弹出的对话框输入id,x,y,r等数据即可.
                \item 图元缩放\\
                      点击画布界面中的图标
                      \includegraphics[scale=0.5]{images/scale_icon.png}, 在弹出的对话框输入id,x,y,s等数据即可.
                \item 图元裁剪\\
                      点击画布界面中的图标
                      \includegraphics[scale=0.5]{images/delete_icon.png}, 在弹出的对话框输入id,x1,y1,x2,y2,algorithm等数据即可.(algorithm支持Cohen-Sutherland和Liang-Barsky)
            \end{enumerate}
    ...
    \subsection{运行结果}
        ...
        \textbf{鼠标功能展示如下}
            ...
            \begin{enumerate}[\indent (1)]
            \item 清空画笔模式，绘制一个点功能就不做赘余的展示了
            \item 重置画布\\
                  点击重置按钮 \includegraphics[scale=0.5]{images/reset_icon.png}
后，画布清空，对话框提示输入新的画布度和高度
                  \begin{center}
                    \includegraphics[scale=0.4]{images/resetCanvas_mouse.jpg}
                  \end{center}
                  随后确认以后，即可看见相应的结果。
            \item 保存画布\\
                  点击保存按钮 \includegraphics[scale=0.5]{images/save_icon.png}
后
                  \begin{center}
                    \includegraphics[scale=0.4]{images/saveCanvas_mouse.jpg}
                  \end{center}
                  随后选择保存路径，确认以后，即可在对应的位置找到相应的bmp文件.
                  由于纯白色背景对眼睛不友好，于是背景色被修改成了以下RGB(219,207,202) 对应的颜色;
            \item 改变颜色:改变画笔的颜色
                  点击颜色修改按钮 \includegraphics[scale=0.5]{images/color_icon.png}
后,弹出对话框
                  \begin{center}
                     \includegraphics[scale=0.4]{images/setColor_mouse_before.jpg}
                  \end{center}
                  随后进行颜色选择，确认后再次绘制即可看见效果.
                  \begin{center}
                    \includegraphics[scale=0.4]{images/setColor_mouse_later.jpg}
                  \end{center}
            \item 绘制直线模式(Bresenham 算法):画笔进入以Bresenham算法绘制直线的模式\\
                  点击绘制直线模式(Bresenham)按钮 \includegraphics[scale=0.5]{images/line_icon.png}后
                  随后进行绘制即可.绘制结果如下:
                  \begin{center}
                    \includegraphics[scale=0.4]{images/drawLine_mouse_Bresenham.jpg}
                  \end{center}
            \item 绘制直线模式(DDA算法):画笔进入以DDA算法绘制直线的模式\\
                  点击绘制直线模式(DDA)按钮 \includegraphics[scale=0.5]{images/line_icon_DDA.png}后
                  随后进行绘制即可.绘制结果如下:
                  \begin{center}
                    \includegraphics[scale=0.4]{images/drawLine_mouse_DDA.jpg}
                  \end{center}
            \item 绘制多边形模式(Bresenham 算法):画笔进入以Bresenham算法绘制多边形的模式:\\
                  点击绘制多边形模式(Bresenham)按钮 \includegraphics[scale=0.5]{images/polygon_icon.png}后
                  随后进行绘制即可.绘制结果如下:
                  \begin{center}
                    \includegraphics[scale=0.4]{images/drawPolygon_mouse_Bresenham.jpg}
                  \end{center}
            \item 绘制多边形模式(DDA 算法)：画笔进入以DDA算法绘制多边形的模式\\
                  点击绘制多边形模式(DDA)按钮 \includegraphics[scale=0.5]{images/polygon_fill_icon.png}后
                  随后进行绘制即可.绘制结果如下:
                  \begin{center}
                    \includegraphics[scale=0.4]{images/drawPolygon_mouse_DDA.jpg}
                  \end{center}
            \item 绘制椭圆模式:画笔进入绘制椭圆的模式\\
                  点击绘制椭圆模式按钮 \includegraphics[scale=0.5]{images/ellipse_icon.png} 后
                  随后输入数据确认;
                  \begin{center}
                    \includegraphics[scale=0.4]{images/drawEllipse_mouse_before.jpg}
                  \end{center}
                  绘制结果如下:
                  \begin{center}
                    \includegraphics[scale=0.4]{images/drawEllipse_mouse_later.jpg}
                  \end{center}
            \item 绘制曲线模式(Bezier曲线):画笔进入以Bezier算法绘制曲线的模式\\
                  点击绘制曲线模式(Bezier)按钮 \includegraphics[scale=0.5]{images/curve_icon.png} 后
                  随后进行绘制即可
                  \begin{center}
                    \includegraphics[scale=0.4]{images/drawCurve_mouse_Bezier.jpg}
                  \end{center}
            \item 绘制曲线模式(B-spline曲线):画笔进入以B-spline算法绘制曲线的模式\\
                  点击绘制曲线模式(B-spline)按钮 \includegraphics[scale=0.5]{images/curve_icon_Bspline.png} 后
                  随后进行绘制即可
                  \begin{center}
                    \includegraphics[scale=0.4]{images/drawCurve_mouse_Bspline.jpg}
                  \end{center}
            \item 平移模式按钮:进入图元平移模式\\
                  \begin{center}
                    \includegraphics[scale=0.4]{images/translate_mouse_before.jpg}
                  \end{center}
                  点击平移模式按钮 \includegraphics[scale=0.5]{images/translate_icon.png}后
                  随后进行平移操作即可
                  \begin{center}
                    \includegraphics[scale=0.4]{images/translate_mouse_later.jpg}
                  \end{center}
            \item 旋转模式按钮:进入图元旋转模式\\
                  点击旋转模式按钮 \includegraphics[scale=0.5]{images/rotate_icon.png} 后
                  \begin{center}
                    \includegraphics[scale=0.4]{images/rotate_mouse_before.jpg}
                  \end{center}
                  随后进行输入相关数据并确认即可
                  \begin{center}
                    \includegraphics[scale=0.4]{images/rotate_mouse_later.jpg}
                  \end{center}
            \item 放缩模式按钮:进入图元放缩模式\\
                  点击缩放模式按钮 \includegraphics[scale=0.5]{images/scale_icon.png} 后
                  \begin{center}
                    \includegraphics[scale=0.4]{images/scale_mouse_before.jpg}
                  \end{center}
                  随后进行输入相关数据并确认即可
                  \begin{center}
                    \includegraphics[scale=0.4]{images/scale_mouse_later.jpg}
                  \end{center}
            \item 裁剪模式按钮:进入图元裁剪模式
                  点击裁剪模式按钮 \includegraphics[scale=0.5]{images/delete_icon.png} 后
                  \begin{center}
                    \includegraphics[scale=0.4]{images/clip_mouse_before.jpg}
                  \end{center}
                  随后进行输入相关数据并确认即可
                  \begin{center}
                    \includegraphics[scale=0.4]{images/clip_mouse_later.jpg}
                  \end{center}
            \end{enumerate}
            
        \subsubsection{命令行运行结果展示}
            \begin{enumerate}[\indent (1)]
                \item 读取$*.txt$文件，文件夹位于$NJU\_CG/scripts$文件夹下，在主界面命令行中输入input name(文件名，不包含后缀)即可.(如果是运行了*.exe 文件，则$*.txt$在此文件夹下的scripts中).
                      输入以下命令后(对id为$canvas\_1$的画布时，命令最后的1可以缺省，否则需输入对应的id) 后：\\
                      input input\_1 1\\
                      将会得到:
                      \begin{center}
                         \includegraphics[scale=0.4]{images/resetCanvas_command_before.jpg}
                      \end{center}
                \item 打印历史命令:list canvas\_id(对id为$canvas\_1$的画布时，命令最后的1 可以缺省，否则需输入对应的id)后：\\
                      打印画布id为canvas\_id的画布上所有执行过的正确指令,其中canvas\_id 缺省为1.
                      \begin{center}
                        \includegraphics[scale=0.4]{images/Command.jpg}
                      \end{center}
                \item 输出历史命令到文件:output name canvas\_id(对id为$canvas\_1$的画布时，命令最后的1可以缺省，否则需输入对应的id)后：\\
                      打印id为canvas\_id的画布上所有执行过的正确指令，输出定向到文件中,可以在
                      name:string 输出文件名
                      输出文件可以在$NJU\_CG/scripts$文件夹下找到。(如果是运行了*.exe 文件，则$*.txt$在此文件夹下的scripts中).
                \item 重置画布\\
                      原来的画布
                      \begin{center}
                         \includegraphics[scale=0.4]{images/resetCanvas_command_before.jpg}
                      ...
                      \begin{center}
                         \includegraphics[scale=0.4]{images/resetCanvas_command_later.jpg}
                      \end{center}
                \item 保存画布\\
                ...
                \item 直线绘制:\\
                      ...
                      将会得到:
                      \begin{center}
                         \includegraphics[scale=0.4]{images/drawLine_command.jpg}
                      \end{center}
                \item 多边形绘制:\\
                      输入以下命令后(对id为$canvas\_1$的画布时，命令最后的1可以缺省，否则需输入对应的id)后：\\
                      ...
                      将会得到:
                      \begin{center}
                         \includegraphics[scale=0.4]{images/drawPolygon_command.jpg}
                      \end{center}
                \item 椭圆绘制:
                      输入以下命令后(对id为$canvas\_1$的画布时，命令最后的1可以缺省，否则需输入对应的id)后：\\
                      ...
                      将会得到:
                      \begin{center}
                         \includegraphics[scale=0.4]{images/drawEllipse_command.jpg}
                      \end{center}
                \item 曲线绘制:\\
                      输入以下命令后(对id为$canvas\_1$的画布时，命令最后的1可以缺省，否则需输入对应的id)后：\\
                      ...
                      将会得到:
                      \begin{center}
                         \includegraphics[scale=0.4]{images/drawCurve_command.jpg}
                      \end{center}
                \item 图元平移:\\
                      依次输入以下命令后(对id为$canvas\_1$的画布时，命令最后的1可以缺省，否则需输入对应的id)后：\\
                      drawLine 1 10 10 200 200 DDA 1\\
                      \begin{center}
                         \includegraphics[scale=0.4]{images/translate_command_before.jpg}
                      \end{center}
                      再输入translate 1 150 100 1\\
                      将会得到:
                      \begin{center}
                         \includegraphics[scale=0.4]{images/translate_command_later.jpg}
                      \end{center}
                \item 图元旋转:\\
                      依次输入以下命令后(对id为$canvas\_1$的画布时，命令最后的1可以缺省，否则需输入对应的id)后：\\
                      drawEllipse 1 200 200 100 80 1\\
                      \begin{center}
                         \includegraphics[scale=0.4]{images/rotate_command_before.jpg}
                      \end{center}
                      再输入rotate 1 200 200 90 1\\
                      将会得到:
                      \begin{center}
                         \includegraphics[scale=0.4]{images/rotate_command_later.jpg}
                      \end{center}
                \item 图元缩放:\\
                      依次输入以下命令后(对id为$canvas\_1$的画布时，命令最后的1可以缺省，否则需输入对应的id)后：\\
                      drawEllipse 1 200 200 100 80 1\\
                      \begin{center}
                         \includegraphics[scale=0.4]{images/scale_command_before.jpg}
                      \end{center}
                      再输入scale 1 200 200 0.5 1\\
                      将会得到:
                      \begin{center}
                         \includegraphics[scale=0.4]{images/scale_command_later.jpg}
                      \end{center}
                \item 线段裁剪:\\
                      依次输入以下命令后(对id为$canvas\_1$的画布时，命令最后的1可以缺省，否则需输入对应的id)后：\\
                      ...
                      \begin{center}
                         \includegraphics[scale=0.4]{images/clip_command_before.jpg}
                      \end{center}
                      再输入clip 1 100 100 300 300 Cohen-Sutherland 1\\
                            clip 2 470 130 530 230 Liang-Barsky 1\\
                      将会得到:
                      \begin{center}
                         \includegraphics[scale=0.4]{images/clip_command_later.jpg}
                      \end{center}
            \end{enumerate}
\section{总结}
